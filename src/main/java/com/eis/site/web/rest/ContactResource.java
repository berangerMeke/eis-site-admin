...
/**
 * REST controller for managing {@link com.eis.site.domain.Contact}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Contact> partialUpdateContact(
        ...
        Optional<Contact> result = contactRepository
            ...
            .map(existingContact -> {
                ...
                if (contact.getBoitePostale() != null) {
                    existingContact.setBoitePostale(contact.getBoitePostale());
                }
                if (contact.getLocalisation() != null) {
                    existingContact.setLocalisation(contact.getLocalisation());
                }
