...
import { EntityArrayResponseType, MembreEquipeService } from '../service/membre-equipe.service';
...
export class MembreEquipeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IMembreEquipe): number => this.membreEquipeService.getMembreEquipeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.membreEquipes = this.refineData(dataFromBody);
  }

  protected refineData(data: IMembreEquipe[]): IMembreEquipe[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IMembreEquipe[] | null): IMembreEquipe[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.membreEquipeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
