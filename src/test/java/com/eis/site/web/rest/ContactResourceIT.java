...
import com.eis.site.domain.Contact;
import com.eis.site.repository.ContactRepository;
...
class ContactResourceIT {
    ...
    void createContact() throws Exception {
        ...
        assertThat(testContact.getBoitePostale()).isEqualTo(DEFAULT_BOITE_POSTALE);
        assertThat(testContact.getLocalisation()).isEqualTo(DEFAULT_LOCALISATION);
    }
    ...
    void putExistingContact() throws Exception {
        ...
        assertThat(testContact.getBoitePostale()).isEqualTo(UPDATED_BOITE_POSTALE);
        assertThat(testContact.getLocalisation()).isEqualTo(UPDATED_LOCALISATION);
    }
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.telephone(UPDATED_TELEPHONE).boitePostale(UPDATED_BOITE_POSTALE).localisation(UPDATED_LOCALISATION);
